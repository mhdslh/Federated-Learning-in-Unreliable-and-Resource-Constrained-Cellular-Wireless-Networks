...
input_dim = 60
output_dim = 10
ETA_0 = 1.0 # Learning rate at iteration 0. In the original paper, it has been choosen from the set {1, 0.1, 0.001}
...
DICT = {'LOSS_SYNTHETIC': LOSS, 'ACCURACY_SYNTHETIC': ACCURACY, 'TEST_ACCURACY_SYNTHETIC': TEST_ACCURACY}
scipy.io.savemat('Step2_Output_Benchmark_SYNTHETIC11.mat', DICT)